...
Public Class BaoCaoTonDAL
    ...
    Public Function Tong_SL_DaSC(ByRef ListofTong_SL_DaSC As List(Of Integer)) As Result
        Dim query As String
        query = String.Empty
    ...
    Public Function Tong_SLPS(ByRef ListofTong_SLPS As List(Of Integer)) As Result
        Dim query As String
        query = String.Empty
